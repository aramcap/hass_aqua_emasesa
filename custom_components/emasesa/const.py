...
# EMASESA publica las franjas horarias (y, por tanto, el corte entre un
# día y el siguiente) en hora local de Sevilla, no en la zona horaria
# que tenga configurada esta instancia de Home Assistant — que
# normalmente coincidirá, pero no tiene por qué.
ZONA_EMASESA = ZoneInfo("Europe/Madrid")
